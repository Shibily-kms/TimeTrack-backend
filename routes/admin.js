...
const { addDesignation, allDesignations, changeStatusOfSales } = require('../controllers/designation-controllers')
...
// Sales Access
router.post('/allow-sales-web', verifyAdmin, changeStatusOfSales)
